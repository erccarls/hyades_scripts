...
def LoadModel(basedir, galprop_tag, AQ_templates=False,psf=-1, split_plane=False, multiplier=1.):
    ...
    A.AddHDF5Template(hdf5file=basedir +'/'+ galprop_tag+'.hdf5',verbosity=1, multiplier=multiplier, bremsfrac=1.25, 
...
def Analyze(basedir, galprop_tag, A, analysis=0, psf=-1):
    ...
    if psf==-1:
        psf_tag = '_tim_front'
    if psf==0:
        psf_tag = '_psf0_tim_front'
    if psf==1:
        psf_tag = '_psf1_tim_front'
    if psf==2:
        psf_tag = '_psf2_tim_front'
    if psf==3:
        psf_tag = '_psf3_tim_front'
    ...
    if analysis == 32:
        ...
        if psf ==-1:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_no_dm_15_bmask2_unconstrained'+psf_tag, A=A, 
                extra_dict=None)
        else:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_no_dm_15_bmask2_unconstrained'+psf_tag, A=A, 
                extra_dict=None)
        ...
        if psf ==-1:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_15_bmask2_unconstrained'+psf_tag, A=A,)
        else: 
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_15_bmask2_unconstrained'+psf_tag, A=A,)
        print 'Dark matter template Raw Values.', list(A.templateList['DM'].value)
        #AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC/', A=A)
    ...
    if analysis == 33:
        ...
        if psf ==-1:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_no_dm_15_bmask2_mult2'+psf_tag, A=A, 
                extra_dict=None)
        else:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_no_dm_15_bmask2_mult2'+psf_tag, A=A, 
                extra_dict=None)
        ...
        if psf ==-1:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_15_bmask2_mult2'+psf_tag, A=A, extra_dict=None)
        else: 
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_15_bmask2_mult2'+psf_tag, A=A,)
        print 'Dark matter template Raw Values.', list(A.templateList['DM'].value)
        #AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC/', A=A)
    ...
    if analysis == 34:
        ...
        if psf ==-1:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_no_dm_15_bmask2_mult.5'+psf_tag, A=A, 
                extra_dict=None)
        else:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_no_dm_15_bmask2_mult.5'+psf_tag, A=A, 
                extra_dict=None)
        ...
        if psf ==-1:
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_15_bmask2_mult.5'+psf_tag, A=A, extra_dict=None)
        else: 
            AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC_15_bmask2_mult.5'+psf_tag, A=A,)
        print 'Dark matter template Raw Values.', list(A.templateList['DM'].value)
        #AddFitMetadata(basedir +'/'+ galprop_tag+'.hdf5', h5_path='/fit_results/GC/', A=A)
...
if __name__ == "__main__":
    ...
    if int(analysis)==9 :
        ...
        A = LoadModel(basedir,galprop_tag, AQ_templates=False, psf=psf, split_plane=split_plane, multiplier=multiplier)
