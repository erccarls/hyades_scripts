...
def RunFit(A, nrings=9, limit_inner=None, fix_xco=False):
    ...
    if limit_inner is not None:
        if fix_xco is False:
            A.templateList['pi0_H2_1'].limits=[limit_inner*1e19/4e19,None] # set inner ring limit to not fall below inner_limit
...
if __name__ == "__main__":
    ...
    fname = basedir+'/'+tag+'_XCO_P8_PSF3.hdf5'
    ...
    # Load the analysis
    A = Analysis.Analysis(tag='P8R2_PSF3_CLEAN_V6_calore', fglpath='/pfs/carlson/gll_psc_v16.fit',  
